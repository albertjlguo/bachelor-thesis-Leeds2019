...
\begin{figure}
\centering
\includegraphics[width = .999\textwidth]{figure/1_1_1_nasa_co2.jpeg}
...
\begin{figure}[htp]
\centering
\includegraphics[width = .8\textwidth]{figure/2_1_freq.jpeg}
...
\begin{figure}[htb]
\centering
\includegraphics[width = .5\textwidth]{figure/3_1_Equilibrium.png}
...
\begin{figure}[htb]
\centering
\includegraphics[width = .618\textwidth]{figure/3_1_Functional.png}
...
\begin{figure}[htb]
\centering
\includegraphics[width =.618\textwidth]{figure/3_1_Power.png}
...
\begin{figure}[htb]
\centering
\includegraphics[width = .9\textwidth]{figure/3_2_steady.png}
...
\begin{figure}[htb]
\centering
\includegraphics[width = .999\textwidth]{figure/3_3_code3.png}
%\caption{ }
\label{3_3_code3}
\end{figure}
...
In this Chapter, we use the algorithms described in the Chapter 3 to test the well-known Nordic system. One-line diagram of the Nordic test system is  shown in Figure\ref{4_1_1_nordic}.\\

\begin{figure}[htb]
\centering
\includegraphics[width = .8\textwidth]{figure/4_1_1_nordic.png}
